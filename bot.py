...
LANG, AGE, GENDER, SYMPTOMS, DURATION, SEVERITY, CONDITIONS, NOTES, FOLLOWUP = range(9)
...
TEXTS = {
    "ar": {
        ...
        "quick_symptoms": [["🤕 صداع", "🌡️ حمى", "😷 سعال"], ["💔 ألم في الصدر", "🤢 غثيان", "😴 تعب وإرهاق"], ["😤 ضيق التنفس", "💫 دوار", "🦴 ألم المفاصل"], ["🤰 ألم في البطن", "🥶 قشعريرة", "👁️ احمرار العيون"], ["✅ انتهيت"]],
