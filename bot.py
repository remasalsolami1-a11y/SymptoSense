...
TEXTS = {
    "ar": {
        ...
        "infermedica_label": "🔬 تحقق من قاعدة معرفة طبية (درجة تطابق إحصائية)",
    },
    "en": {
        ...
        "infermedica_label": "🔬 Checked against medical knowledge base (statistical match score)",
    }
}
        ...
        try:
            ...
            if verified:
                ...
                for cond in verified:
                    ...
                    lines.append(f"• {cond[name_key]}: {pct}%")
                infermedica_block = "\n".join(lines)
