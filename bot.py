...
TEXTS = {
    "ar": {
        ...
        "quick_symptoms": [["🤕 صداع", "🤒 حمى", "😷 سعال"], ["🫀 ألم في الصدر", "🤢 غثيان", "😴 تعب وإرهاق"], ["🫁 ضيق التنفس", "💫 دوار", "🦴 ألم المفاصل"], ["😖 ألم في البطن", "🥶 قشعريرة", "👁️ احمرار العيون"], ["✍️ ما لقيت اللي أحس فيه — اكتبه"], ["✅ انتهيت"]],
    ...
    "en": {
        ...
        "quick_symptoms": [["🤕 Headache", "🌡️ Fever", "😷 Cough"], ["💔 Chest Pain", "🤢 Nausea", "😴 Fatigue"], ["😤 Shortness of Breath", "💫 Dizziness", "🦴 Joint Pain"], ["🤰 Stomach Pain", "🥶 Chills", "👁️ Red Eyes"], ["✍️ Not listed — I'll type it"], ["✅ Done"]],
