...
{{"urgency":"low|medium|high","urgency_ar":"بسيط|يحتاج موعد طبيب|طوارئ","possible_conditions":"الاحتمالات بالعربية فقط (3 جمل)","recommendations":["نصيحة بالعربية","نصيحة بالعربية","نصيحة بالعربية","نصيحة بالعربية"],"danger_signs":"علامات الخطر بالعربية فقط","when_to_seek_care":"متى تراجع الطبيب بالعربية فقط","home_care":"الرعاية المنزلية بالعربية فقط"}}"""
    else:
...
{{"urgency":"low|medium|high","urgency_text":"Simple|Needs appointment|Emergency","possible_conditions":"Possible conditions in English only (3 sentences)","recommendations":["tip in English","tip in English","tip in English","tip in English"],"danger_signs":"Danger signs in English only","when_to_seek_care":"When to see a doctor in English only","home_care":"Home care tips in English only"}}"""
