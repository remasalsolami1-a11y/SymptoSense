...
<meta name="description" content="SymptoSense — مساعدك الذكي لتحليل الأعراض وتقييم الحالة الصحية الأولي بناءً على مصادر طبية موثوقة.">
<style>__CSS__</style>
</head>
<body>
<nav class="nav">
...
def _page(title, body):
    return PAGE_FRAME.replace("__TITLE__", title).replace("__CSS__", BASE_CSS).replace("__BODY__", body)
