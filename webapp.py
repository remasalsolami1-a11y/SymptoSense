...
.chat-head .spk-btn { margin-left: auto; background: rgba(255,255,255,.15); border: none; border-radius: 10px; padding: 8px 10px; font-size: 18px; cursor: pointer; color: #fff; }
...
def chat_page():
    ...
    <div class="chat-wrap">
      <div class="chat-head">
        ...
        <button id="spkBtn" class="spk-btn" onclick="toggleSpeak()" title="قراءة الرسائل صوتياً">🔊</button>
      </div>
