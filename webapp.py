...
GREETINGS = [
    ("🇸🇦", "مرحباً بكم في SymptoSense"),
    ("🇬🇧", "Welcome to SymptoSense"),
    ("🇹🇷", "SymptoSense'ye hoş geldiniz"),
    ("🇵🇭", "Maligayang pagdating sa SymptoSense"),
    ("🇫🇷", "Bienvenue sur SymptoSense"),
    ("🇪🇸", "Bienvenidos a SymptoSense"),
    ("🇩🇪", "Willkommen bei SymptoSense"),
    ("🇮🇳", "SymptoSense में आपका स्वागत है"),
    ("🇵🇰", "SymptoSense میں خوش آمدید"),
    ("🇮🇩", "Selamat datang di SymptoSense"),
    ("🇧🇩", "SymptoSense-এ স্বাগতম"),
    ("🇷🇺", "Добро пожаловать в SymptoSense"),
    ("🇨🇳", "欢迎来到 SymptoSense"),
    ("🇺🇦", "Ласкаво просимо до SymptoSense"),
]


def welcome_page():
    greet = "".join(
        '<div class="greet-line"><span class="gflag">%s</span><span>%s</span></div>' % (f, t)
    ...
    <div class="welcome-wrap">
      <div class="welcome-card">
        ...
        <h1>""" + _t("w_title") + """</h1>
        <p class="muted" style="margin-top:2px;margin-bottom:18px;">""" + _t("w_pick") + """</p>
        <div class="multi-greet">""" + greet + """</div>
        <div class="lang-row">
          <div class="lang-btn" onclick="setLang('ar')" role="button" tabindex="0">
            <span class="lc">🇸🇦</span><span class="lt">""" + _t("w_ar_l") + """</span><span class="ld">""" + _t("w_ar_d") + """</span>
          </div>
          <div class="lang-btn" onclick="setLang('en')" role="button" tabindex="0">
            <span class="lc">🇬🇧</span><span class="lt">""" + _t("w_en_l") + """</span><span class="ld">""" + _t("w_en_d") + """</span>
          </div>
        </div>
        <p class="muted" style="margin-top:22px;margin-bottom:0;">""" + _t("desc") + """</p>
      </div>
    </div>
    """
