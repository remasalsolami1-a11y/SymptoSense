...
def _all_records():
    ...
    try:
        c = conn.cursor()
        c.execute(
            "SELECT id, user_hash, timestamp, lang, age, gender, symptoms, conditions, medications, "
...
def export_all_records_csv():
    ...
    writer.writerow(["id","user_hash","timestamp","lang","age","gender","symptoms","conditions","medications","duration","severity","urgency"])
...
def export_all_records_xlsx():
    ...
    headers = ["id","user_hash","timestamp","lang","age","gender","symptoms","conditions","medications","duration","severity","urgency"]
    ws.append(headers)
    for row in rows:
        ws.append(list(row))
